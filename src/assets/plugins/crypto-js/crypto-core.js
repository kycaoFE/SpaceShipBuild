(function(root){var exports=undefined,module=undefined,require=undefined;var define=undefined;var self=root,window=root,global=root,globalThis=root;(function(){/* eslint-disable no-prototype-builtins */ /* globals , globalThis*/ /**
 * CryptoJS core components.
 */ // eslint-disable-next-line no-shadow-restricted-names
const CryptoJS=function(Math,undefined){var crypto;// Native crypto from window (Browser)
 ...
 */ // eslint-disable-next-line no-shadow-restricted-names
CryptoJS.lib.Cipher||function(){// Shortcuts
var C=CryptoJS;var C_lib=C.lib;var Base=C_lib.Base;var WordArray=C_lib.WordArray;var BufferedBlockAlgorithm=C_lib.BufferedBlockAlgorithm;var C_enc=C.enc;// eslint-disable-next-line no-unused-vars
var Utf8=C_enc.Utf8;var Base64=C_enc.Base64;var C_algo=C.algo;var EvpKDF=C_algo.EvpKDF;/**
...
var plaintext=SerializableCipher.decrypt.call(this,cipher,ciphertext,derivedParams.key,cfg);return plaintext;}});}();globalThis.CryptoJS=CryptoJS;}).call(root);})(// The environment-specific global.
