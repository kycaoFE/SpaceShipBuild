 ...
 * MD5 hash algorithm.
 */const MD5=C_algo.MD5=Hasher.extend({_doReset:function(){this._hash=new WordArray.init([0x67452301,0xefcdab89,0x98badcfe,0x10325476]);},_doProcessBlock:function(M,offset){// Swap endian
 ...
 */C.HmacMD5=Hasher._createHmacHelper(MD5);}).call(root);})(// The environment-specific global.
